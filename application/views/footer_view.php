...
<script src="<?php echo base_url(); ?>assets_style/assets/dist/js/Chart.js"></script>
<script type="text/javascript">
  var ctx = document.getElementById('bulanChart').getContext('2d');
