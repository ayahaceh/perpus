        ...
        <ul class="sidebar-menu" data-widget="tree">
            <?php if ($this->session->userdata('level') == 'Petugas') { ?>
                ...
                <li class="treeview active">
                    <a href="#"><i class="fa fa-list-alt"></i><span>Laporan</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="<?php echo base_url("laporan"); ?>" target="_blank" class="cursor">
                                <span class="fa fa-book text-success"></span> Buku Tersedia
                            </a>
                        </li>
                        <li class="active">
                            <a href="<?php echo base_url("laporan/dipinjam"); ?>" target="_blank" class="cursor">
                                <span class="fa fa-book text-danger"></span> Buku Sedang Dipinjam
                            </a>
                        </li>
                        <li class="active">
                            <a href="<?php echo base_url("laporan/buku_baru_pilih"); ?>" class="cursor">
                                <span class="fa fa-book text-primary"></span> Buku Baru Masuk
                            </a>
                        </li>
                        <li class="active">
                            <a href="<?php echo base_url("laporan/pinjam_baru_pilih"); ?>" class="cursor">
                                <span class="fa fa-book text-warning"></span> Buku Baru Dipinjam
                            </a>
                        </li>
