...
<head>
  ...
  <!--  Custom CSS  -->
  <link rel="stylesheet" href="<?php echo base_url('assets_style/assets/dist/css/style.css'); ?>">
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bg-perpus.jpg'); ?>')no-repeat;background-size:100%;">
  <div class="login-box2">
    ...
    <div class="login-box-body">
      <div class=" login-logo">
        <img src="<?php echo base_url(); ?>assets_style/image/smk.png" width="140px">
        <h3>Sistem Informasi Perpustakaan</h3>
        <h4>SMK INFORMATIKA PASUNDAN</h4>
      </div>
    ...
    <br />
    <footer>
      <div class="login-box-body-footer text-center">
        <a> Copyright &copy; Sistem Perpustakaan - <?php echo date("Y"); ?>
      </div>
    </footer>
  </div>
  <!-- /.login-box -->
